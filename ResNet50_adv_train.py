...
model_save_path = './models/ResNet50_mnist2.pth'
...
trainset = AdversarialDataset(adv_data_file="./attackData/MNIST/ResNet50_datas.npy", label_file="./attackData/MNIST/ResNet50_labels.npy", transform=transform)
...
# save model
model_save_path2 = './models/AdvResNet50_mnist.pth'
