...
# 定义模型、损失函数和优化器
model = ModifiedDenseNet161(num_classes=200).to(device)
...
# 保存模型
model_save_path = 'boundary_robustness/models/imageNet/AdvDenseNet161_imageNet.pth'
# torch.save(model.state_dict(), model_save_path)
# print(f'Model saved to {model_save_path}')


# 创建新的DenseNet161模型实例
loaded_model = ModifiedDenseNet161(num_classes=200).to(device)
