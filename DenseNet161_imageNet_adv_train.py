...
model_save_path = './models/imageNet/DenseNet161_imageNet.pth'
...
trainset = AdversarialDataset(adv_data_file="./attackData/ImageNet/DenseNet161_datas.npy", label_file="./attackData/ImageNet/DenseNet161_labels.npy", transform=transform)
...
model_save_path2 = './models/imageNet/AdvDenseNet161_imageNet.pth'
# torch.save(model.state_dict(), model_save_path2)
# print(f'Model saved to {model_save_path2}')


# Creating a new DenseNet61 model instance
