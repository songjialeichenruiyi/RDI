...
model_save_path = './models/imageNet/ResNet50_imageNet_2.pth'
...
trainset = AdversarialDataset(adv_data_file="./attackData/ImageNet/ResNet50_datas.npy", label_file="./attackData/ImageNet/ResNet50_labels.npy", transform=transform)
...
# save model
model_save_path2 = './models/imageNet/AdvResNet50_imageNet.pth'
