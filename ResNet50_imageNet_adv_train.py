...
class ModifiedResNet50(nn.Module):
    def __init__(self, num_classes=200):  #  TinyImageNet类别数为 200
        super(ModifiedResNet50, self).__init__()
        self.model = models.resnet50(weights = None)  # 使用预训练的 ResNet50
...
model_save_path = 'boundary_robustness/models/imageNet/ResNet50_imageNet_2.pth'
# 加载模型参数
...
# 创建对抗数据集
trainset = AdversarialDataset(adv_data_file="boundary_robustness/attackData/ImageNet/ResNet50_datas.npy", label_file="boundary_robustness/attackData/ImageNet/ResNet50_labels.npy", transform=transform)
...
# 保存模型
model_save_path2 = 'boundary_robustness/models/imageNet/AdvResNet50_imageNet_2.pth'
