...
model_save_path = './models/FashionMNIST/MobileNetV2_FashionMNIST.pth'
...
trainset = AdversarialDataset(adv_data_file="./attackData/FashionMNIST/MobileNetV2_datas.npy", label_file="./attackData/FashionMNIST/MobileNetV2_labels.npy", transform=transform)
...
model_save_path2 = './models/FashionMNIST/AdvMobileNetV2_FashionMNIST.pth'
