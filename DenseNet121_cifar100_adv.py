...
train_dataset = datasets.CIFAR100(root='.s/data', train=True, download=True, transform=transform)
...
np.save('./attackData/Cifar100/DenseNet121_datas.npy', adv_data)
np.save('.s/attackData/Cifar100/DenseNet121_labels.npy', labels)
