...
model_save_path = 'boundary_robustness/models/FashionMNIST/Res101_FashionMNIST.pth'
# 加载模型参数
...
# 创建对抗数据集
trainset = AdversarialDataset(adv_data_file="boundary_robustness/attackData/FashionMNIST/ResNet101_datas.npy", label_file="boundary_robustness/attackData/FashionMNIST/ResNet101_labels.npy", transform=transform)
...
# 保存模型
model_save_path2 = 'boundary_robustness/models/FashionMNIST/AdvResNet101_FashionMNIST.pth'
