...
# 创建对抗数据集
trainset = AdversarialDataset(adv_data_file="boundary_robustness/attackData/Cifar100/ResNet50_datas.npy", label_file="boundary_robustness/attackData/Cifar100/ResNet50_labels.npy", transform=transform)
...
# 保存模型
model_save_path2 = 'boundary_robustness/models/cifar100/AdvResNet50_cifar100_3.pth'
