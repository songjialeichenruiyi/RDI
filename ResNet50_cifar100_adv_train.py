...
model_save_path = './models/cifar100/ResNet50_cifar100_3.pth'
model.load_state_dict(torch.load(model_save_path))
model.eval()

# 2. Custom dataset class for loading adversarial samples
...
trainset = AdversarialDataset(adv_data_file="./attackData/Cifar100/ResNet50_datas.npy", label_file="./attackData/Cifar100/ResNet50_labels.npy", transform=transform)
...
# Hybrid data loader generation function
...
# save model
model_save_path2 = './models/cifar100/AdvResNet50_cifar100.pth'
