...
np.save('boundary_robustness/attackData/MNIST/MobileNetV2_datas.npy', adv_data)  # 保存对抗样本
np.save('boundary_robustness/attackData/MNIST/MobileNetV2_labels.npy', labels)   # 保存标签
