...
class ModifiedMobileNetV2(nn.Module):
    def __init__(self, num_classes=200):  # CIFAR-100 类别数为 100
        ...
        self.model = models.mobilenet_v2(weights = None)  # 使用预训练的 MobileNetV2
...
# 创建对抗数据集
trainset = AdversarialDataset(adv_data_file="boundary_robustness/attackData/ImageNet/MobileNetV2_datas.npy", label_file="boundary_robustness/attackData/ImageNet/MobileNetV2_labels.npy", transform=transform)
...
# 保存模型
model_save_path2 = 'boundary_robustness/models/imageNet/AdvMobileNetV2_imageNet_2.pth'
