...
model = ModifiedResNet50(num_classes=100).to(device)
...
# save model
model_save_path = './models/cifar100/ResNet50_cifar100.pth'
# torch.save(model.state_dict(), model_save_path)
# print(f'Model saved to {model_save_path}')

loaded_model = ModifiedResNet50(num_classes=100).to(device)
