...
trainset = AdversarialDataset(adv_data_file="./attackData/Cifar10/ResNet50_datas.npy", label_file="./attackData/Cifar10/ResNet50_labels.npy", transform=transform)
...
# save mdoel
model_save_path2 = './models/cifar10/AdvResNet50_cifar10.pth'
