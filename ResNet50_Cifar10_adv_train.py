...
# 加载torchvision.models中的ResNet50模型，并修改输出层以适应CIFAR-10数据集
...
model_save_path = 'boundary_robustness/models/cifar10/ResNet50_cifar10.pth'
# 加载模型参数
...
# 创建对抗数据集
trainset = AdversarialDataset(adv_data_file="boundary_robustness/attackData/Cifar10/ResNet50_datas.npy", label_file="boundary_robustness/attackData/Cifar10/ResNet50_labels.npy", transform=transform)
...
# 保存模型
model_save_path2 = 'boundary_robustness/models/cifar10/AdvResNet50_cifar10.pth'
