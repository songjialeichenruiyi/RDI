...
np.save('boundary_robustness/attackData/ImageNet/VIT_datas.npy', adv_data)  # 保存对抗样本
np.save('boundary_robustness/attackData/ImageNet/VIT_labels.npy', labels)   # 保存标签
