...
trainset = AdversarialDataset(adv_data_file="./attackData/Cifar100/ResNet101_datas.npy", label_file="./attackData/Cifar100/ResNet101_labels.npy", transform=transform)
...
# save model
model_save_path2 = './models/cifar100/AdvResNet101_cifar100.pth'
