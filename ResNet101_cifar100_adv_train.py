...
model_save_path = 'boundary_robustness/models/cifar100/ResNet101_cifar100.pth'
# 加载模型参数
...
# 创建对抗数据集
trainset = AdversarialDataset(adv_data_file="boundary_robustness/attackData/Cifar100/ResNet101_datas.npy", label_file="boundary_robustness/attackData/Cifar100/ResNet101_labels.npy", transform=transform)
...
# 保存模型
model_save_path2 = 'boundary_robustness/models/cifar100/AdvResNet101_cifar100.pth'
