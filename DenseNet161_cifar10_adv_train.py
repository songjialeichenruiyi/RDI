...
# Loading the DenseNet161 model in torchvision.models and modifying the output layer to fit the CIFAR-10 dataset
...
model_save_path = './models/cifar10/DenseNet161_cifar10_2.pth'
...
trainset = AdversarialDataset(adv_data_file="./attackData/Cifar10/DenseNet161_datas.npy", label_file="./attackData/Cifar10/DenseNet161_labels.npy", transform=transform)
...
model_save_path2 = './models/cifar10/AdvDenseNet161_cifar10.pth'
