...
# 创建对抗数据集
trainset = AdversarialDataset(adv_data_file="boundary_robustness/attackData/Cifar10/DenseNet161_datas.npy", label_file="boundary_robustness/attackData/Cifar10/DenseNet161_labels.npy", transform=transform)
...
# 保存模型
model_save_path2 = 'boundary_robustness/models/cifar10/AdvDenseNet161_cifar10_2.pth'
