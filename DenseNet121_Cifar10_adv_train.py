...
model_save_path = 'boundary_robustness/models/cifar10/DenseNet121_cifar10_2.pth'
# 加载模型参数
...
# 创建对抗数据集
trainset = AdversarialDataset(adv_data_file="boundary_robustness/attackData/Cifar10/DenseNet121_datas.npy", label_file="boundary_robustness/attackData/Cifar10/DenseNet121_labels.npy", transform=transform)
...
# 保存模型
model_save_path2 = 'boundary_robustness/models/cifar10/AdvDenseNet121_cifar10_22.pth'
