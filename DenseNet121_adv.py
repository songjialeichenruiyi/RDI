...
np.save('boundary_robustness/attackData/MNIST/DenseNet121_datas2.npy', adv_data)  # 保存对抗样本
np.save('boundary_robustness/attackData/MNIST/DenseNet121_labels2.npy', labels)   # 保存标签
