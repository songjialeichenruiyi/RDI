...
# 创建对抗数据集
trainset = AdversarialDataset(adv_data_file="boundary_robustness/attackData/FashionMNIST/ResNet50_datas.npy", label_file="boundary_robustness/attackData/FashionMNIST/ResNet50_labels.npy", transform=transform)
...
# 保存模型
model_save_path2 = 'boundary_robustness/models/FashionMNIST/AdvResNet50_FashionMNIST_3.pth'
