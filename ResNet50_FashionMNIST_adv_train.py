...
model_save_path = './models/FashionMNIST/ResNet50_FashionMNIST_3.pth'
...
# 创建对抗数据集
trainset = AdversarialDataset(adv_data_file="./attackData/FashionMNIST/ResNet50_datas.npy", label_file="./attackData/FashionMNIST/ResNet50_labels.npy", transform=transform)
...
optimizer = optim.Adam(model.parameters(), lr=0.000003, weight_decay=5e-4)
...
# save model
model_save_path2 = './models/FashionMNIST/AdvResNet50_FashionMNIST.pth'
