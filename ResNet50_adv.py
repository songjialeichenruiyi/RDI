...
np.save('boundary_robustness/attackData/MNIST/ResNet50_datas.npy', adv_data)  # 保存对抗样本
np.save('boundary_robustness/attackData/MNIST/ResNet50_labels.npy', labels)   # 保存标签
