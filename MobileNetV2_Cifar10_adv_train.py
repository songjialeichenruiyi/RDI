...
model_save_path = 'boundary_robustness/models/cifar10/MobileNetV2_cifar10.pth'
# 加载模型参数
...
# 创建对抗数据集
trainset = AdversarialDataset(adv_data_file="boundary_robustness/attackData/Cifar10/MobileNetV2_datas.npy", label_file="boundary_robustness/attackData/Cifar10/MobileNetV2_labels.npy", transform=transform)
...
# 保存模型
model_save_path2 = 'boundary_robustness/models/cifar10/AdvMobileNetV2_cifar10.pth'
