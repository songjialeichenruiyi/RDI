...
np.save('boundary_robustness/attackData/Cifar10/ResNet50_datas.npy', adv_data)  # 保存对抗样本
np.save('boundary_robustness/attackData/Cifar10/ResNet50_labels.npy', labels)   # 保存标签
