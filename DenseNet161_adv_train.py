...
model_save_path = 'boundary_robustness/models/DenseNet161_mnist.pth'
# 加载模型参数
...
# 创建对抗数据集
trainset = AdversarialDataset(adv_data_file="boundary_robustness/attackData/MNIST/DenseNet161_datas.npy", label_file="boundary_robustness/attackData/MNIST/DenseNet161_labels.npy", transform=transform)
...
optimizer = optim.Adam(model.parameters(), lr=0.000004, weight_decay=5e-4)
...
# 保存模型
model_save_path2 = 'boundary_robustness/models/AdvDenseNet161_mnist.pth'
