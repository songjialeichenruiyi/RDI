...
trainset = AdversarialDataset(adv_data_file="./attackData/MNIST/DenseNet161_datas.npy", label_file="./attackData/MNIST/DenseNet161_labels.npy", transform=transform)
...
model_save_path2 = './models/AdvDenseNet161_mnist.pth'
