...
np.save('boundary_robustness/attackData/FashionMNIST/DenseNet121_datas.npy', adv_data)  # 保存对抗样本
np.save('boundary_robustness/attackData/FashionMNIST/DenseNet121_labels.npy', labels)   # 保存标签
