...
np.save('./attackData/FashionMNIST/DenseNet121_datas.npy', adv_data)  # save adversarial samples
np.save('./attackData/FashionMNIST/DenseNet121_labels.npy', labels)   # save labels
