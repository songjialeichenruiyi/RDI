...
model_save_path = './models/imageNet/MobileNetV2_imageNet_2.pth'
...
np.save('./attackData/ImageNet/MobileNetV2_datas.npy', adv_data) 
np.save('./attackData/ImageNet/MobileNetV2_labels.npy', labels)
