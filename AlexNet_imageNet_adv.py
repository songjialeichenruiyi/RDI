...
np.save('boundary_robustness/attackData/ImageNet/AlexNet_datas.npy', adv_data)  # save adversarial samples 
np.save('boundary_robustness/attackData/ImageNet/AlexNet_labels.npy', labels)   # save labels
