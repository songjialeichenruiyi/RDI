...
# Customizing the DenseNet121 model class
class DenseNet121_MNIST(nn.Module):
    def __init__(self, num_classes=10):
        ...
        # Modify the first convolutional layer to accommodate 1-channel MNIST data
        ...
        # Remove the first maximum pooling layer to prevent the feature map from shrinking too quickly
...
optimizer = optim.Adam(DenseNet121.parameters(), lr=0.0005)
...
model_save_path = './models/AdvDenseNet121_mnist.pth'
