...
# 创建对抗数据集
trainset = AdversarialDataset(adv_data_file="boundary_robustness/attackData/ImageNet/AlexNet_datas.npy", label_file="boundary_robustness/attackData/ImageNet/AlexNet_labels.npy", transform=transform)
...
optimizer = optim.SGD(model.parameters(), lr=0.001, momentum=0.5, weight_decay=5e-4)
...
# 保存模型
model_save_path2 = 'boundary_robustness/models/imageNet/AdvAlexNet_imageNet_33.pth'
