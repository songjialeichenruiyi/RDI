...
# 选项1: M5模型 - TorchAudio官方示例中使用的语音命令识别模型
class M5(nn.Module):
    """
    M5网络架构，专为语音命令识别设计
    参考: https://arxiv.org/pdf/1610.00087.pdf
    """
...
# 保存最终模型
model_save_path = './boundary_robustness/models/speech/speech_M5_10class_2.pth'
# torch.save(model.state_dict(), model_save_path)
# print(f'最终模型已保存到 {model_save_path}')

# 加载模型并测试
print("加载最佳模型...")
best_model = M5().to(device)  # 确保与训练的模型架构一致
