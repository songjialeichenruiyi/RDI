...
model_save_path = './models/DenseNet161_mnist.pth'
model.load_state_dict(torch.load(model_save_path))
model.eval()

adv_data, labels = PGD_attack.save_pgd_attack(model=model, test_loader=train_loader)

np.save('./attackData/MNIST/DenseNet161_datas.npy', adv_data)
np.save('./attackData/MNIST/DenseNet161_labels.npy', labels) 
