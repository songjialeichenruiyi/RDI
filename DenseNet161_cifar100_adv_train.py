...
# 创建对抗数据集
trainset = AdversarialDataset(adv_data_file="boundary_robustness/attackData/Cifar100/DenseNet161_datas.npy", label_file="boundary_robustness/attackData/Cifar100/DenseNet161_labels.npy", transform=transform)
adv_train_loader = DataLoader(trainset, batch_size=96, shuffle=True)
...
# 保存模型
model_save_path2 = 'boundary_robustness/models/cifar100/AdvDenseNet161_cifar100_3.pth'
