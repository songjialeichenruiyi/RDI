...
model_save_path = './models/cifar10/ResNet101_cifar10.pth'
...
trainset = AdversarialDataset(adv_data_file="./attackData/Cifar10/ResNet101_datas.npy", label_file="./attackData/Cifar10/ResNet101_labels.npy", transform=transform)
...
# save model
model_save_path2 = './models/cifar10/AdvResNet101_cifar10.pth'
