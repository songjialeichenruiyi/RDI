...
model_save_path = 'boundary_robustness/models/Res101_mnist2.pth'
# 加载模型参数
...
# 创建对抗数据集
trainset = AdversarialDataset(adv_data_file="boundary_robustness/attackData/MNIST/ResNet101_datas.npy", label_file="boundary_robustness/attackData/MNIST/ResNet101_labels.npy", transform=transform)
...
optimizer = optim.Adam(model.parameters(), lr=0.00000004, weight_decay=5e-4)
...
# 保存模型
model_save_path2 = 'boundary_robustness/models/AdvResNet101_mnist2.pth'
