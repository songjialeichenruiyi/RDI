...
model_save_path = './models/Res101_mnist2.pth'
...
trainset = AdversarialDataset(adv_data_file="./attackData/MNIST/ResNet101_datas.npy", label_file="./attackData/MNIST/ResNet101_labels.npy", transform=transform)
...
optimizer = optim.Adam(model.parameters(), lr=0.0004, weight_decay=5e-4)
...
# save model
model_save_path2 = './models/AdvResNet101_mnist.pth'
