...
if torch.cuda.is_available():
    model = nn.DataParallel(model, device_ids=[1, 3])  # 使用四张 GPU
...
# 创建对抗数据集
trainset = AdversarialDataset(adv_data_file="boundary_robustness/attackData/ImageNet/VIT_datas.npy", label_file="boundary_robustness/attackData/ImageNet/VIT_labels.npy", transform=transform)
...
# 保存模型
model_save_path2 = 'boundary_robustness/models/imageNet/AdvVIT_imageNet_2.pth'
